...
use App\Filament\Resources\PharmacyBranchResource\Pages;
use App\Filament\Resources\PharmacyBranchResource\RelationManagers;
...
class PharmacyBranchResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ListPharmacyBranches::route('/'),
            'create' => Pages\CreatePharmacyBranch::route('/create'),
            'edit' => Pages\EditPharmacyBranch::route('/{record}/edit'),
        ];
    }
}
