...
use App\Filament\Resources\FitnessResource\Pages;
use App\Filament\Resources\FitnessResource\RelationManagers;
...
{
    protected static ?string $model = Fitness::class;
    ...
    {
        return [
            'index' => Pages\ListFitnesses::route('/'),
