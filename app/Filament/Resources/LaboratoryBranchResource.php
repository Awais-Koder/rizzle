...
use App\Filament\Resources\LaboratoryBranchResource\Pages;
use App\Filament\Resources\LaboratoryBranchResource\RelationManagers;
...
class LaboratoryBranchResource extends Resource
{
    protected static ?string $model = LaboratoryBranch::class;
    ...
    {
        return [
            'index' => Pages\ListLaboratoryBranches::route('/'),
            'create' => Pages\CreateLaboratoryBranch::route('/create'),
            'edit' => Pages\EditLaboratoryBranch::route('/{record}/edit'),
        ];
    }
}
